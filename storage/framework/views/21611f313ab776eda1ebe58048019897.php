<?php $__env->startSection('title', 'Premium Management'); ?>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="border-t border-slate-100">
                            ...
                            <td class="px-6 py-5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($company->subscription_end): ?>
                                    <span class="text-sm <?php echo e($isExpiringSoon ? 'font-semibold text-amber-600' : 'text-slate-600'); ?>">
                                        <?php echo e($company->subscription_end->translatedFormat('d M Y')); ?>

                                    </span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isExpiringSoon): ?>
                            ...
                            <td class="px-6 py-5 text-right">
                                <button
                                    type="button"
                                    onclick="document.getElementById('modal-plan-<?php echo e($company->id); ?>').classList.remove('hidden'); document.getElementById('modal-plan-<?php echo e($company->id); ?>').classList.add('flex')"
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div
        id="modal-plan-<?php echo e($company->id); ?>"
        ...
        <div class="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
            <div class="mb-6 flex items-start justify-between">
                ...
                <button
                    type="button"
                    onclick="document.getElementById('modal-plan-<?php echo e($company->id); ?>').classList.add('hidden'); document.getElementById('modal-plan-<?php echo e($company->id); ?>').classList.remove('flex')"
            ...
            <form
                method="POST"
                action="<?php echo e(route('platform.premium.update', $company)); ?>"
                class="space-y-4">
                <?php echo csrf_field(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($company->subscription_plan !== 'Free'): ?>
                <form
                    method="POST"
                    action="<?php echo e(route('platform.premium.cancel', $company)); ?>"
                    class="mt-3"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Husin\Documents\SWMS_Backup3\resources\views/platform/premium/index.blade.php ENDPATH**/ ?>