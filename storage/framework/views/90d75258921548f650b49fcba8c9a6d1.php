    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showForm): ?>
        ...
        <div class="mb-6 rounded-2xl border border-blue-200 bg-blue-50/50 p-5">
            ...
            <h4 class="mb-4 font-semibold text-slate-800">
                <?php echo e($editingId ? 'Edit Position' : 'Tambah Position Baru'); ?>
        ...
        <table class="min-w-full divide-y divide-slate-200">
            ...
            <tbody class="divide-y divide-slate-200 bg-white">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr wire:key="position-<?php echo e($position->id); ?>" class="hover:bg-slate-50">

                        <td class="px-4 py-3 text-sm font-semibold text-slate-800"><?php echo e($position->code); ?></td>

                        <td class="px-4 py-3 text-sm text-slate-700"><?php echo e($position->name); ?></td>

                        <td class="px-4 py-3 text-center text-sm text-slate-500"><?php echo e($position->employment_histories_count); ?></td>

                        <td class="px-4 py-3 text-center">

                            <button
                                type="button"
                                wire:click="toggleStatus(<?php echo e($position->id); ?>)"
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button
                                    type="button"
                                    wire:click="editPosition(<?php echo e($position->id); ?>)"
                                    title="Edit Position"
                                ...
                                <button
                                    type="button"
                                    wire:click="deletePosition(<?php echo e($position->id); ?>)"
...
<?php endif; ?>
<?php /**PATH C:\Users\Husin\Documents\SWMS_Backup3\resources\views/livewire/position-manager.blade.php ENDPATH**/ ?>