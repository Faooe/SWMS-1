...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => 'Edit Company','description' => 'Perbarui informasi perusahaan.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Company','description' => 'Perbarui informasi perusahaan.']); ?>

        <a
            href="<?php echo e(route('platform.companies.show',$company)); ?>">
...
<?php endif; ?>
    ...
    <form
        ...
        action="<?php echo e(route('platform.companies.update',$company)); ?>"
        ...
        <?php echo $__env->make('platform.company._form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Husin\Documents\SWMS_Backup3\resources\views/platform/company/edit.blade.php ENDPATH**/ ?>