...
<div class="rounded-3xl bg-white p-8 shadow">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($status):
        ...
        case ('Assigned'): ?>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <form method="POST" action="<?php echo e(route('employee.assignments.reject', $assignment->uuid)); ?>">
                ...
                <form method="POST" action="<?php echo e(route('employee.assignments.accept', $assignment->uuid)); ?>">
        ...
        <div class="space-y-4">
            ...
            <a target="_blank" href="https://www.google.com/maps?q=<?php echo e($assignment->latitude); ?>,<?php echo e($assignment->longitude); ?>" class="flex items-center justify-center rounded-2xl border py-3 font-semibold">

                Open Navigation

            </a>

            <form id="assignment-check-in-form" method="POST" action="<?php echo e(route('employee.assignments.check-in', $assignment->uuid)); ?>">
    ...
    <?php break; ?>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <form id="assignment-check-out-form" method="POST" action="<?php echo e(route('employee.assignments.check-out', $assignment->uuid)); ?>">
            ...
            <form method="POST" action="<?php echo e(route('employee.assignments.complete', $assignment->uuid)); ?>" enctype="multipart/form-data">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['completion_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>

                    <p class="mb-2 text-xs text-red-600"><?php echo e($message); ?></p>
    ...
    <?php break; ?>
        ...
        <?php case ('Completed'): ?>
            ...
            <div class="rounded-2xl bg-green-50 p-8 text-center">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pivot?->completion_photo): ?>
                    ...
                    <div class="mt-6">
                        ...
                        <img src="<?php echo e(Storage::url($pivot->completion_photo)); ?>" alt="Foto bukti selesai" class="mx-auto max-h-80 rounded-2xl border border-green-200 object-cover">
...
</div><?php /**PATH C:\Users\Husin\Documents\SWMS_Backup3\resources\views/employee/assignments/partials/actions.blade.php ENDPATH**/ ?>