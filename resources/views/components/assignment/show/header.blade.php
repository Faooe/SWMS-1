    ...
    <div>
        ...
        <div class="mt-4 flex flex-wrap gap-3">
            ...
            @php
                ...
                $statusColor = match($companyStatus){
            ...
            @if($assignment->daily_attendance_enabled)
                <span class="inline-flex items-center gap-1.5 rounded-full bg-cyan-100 px-4 py-2 text-sm font-semibold text-cyan-700">
                    <i data-lucide="calendar-check-2" class="h-4 w-4"></i>
                    {{ $assignment->attendance_day_rule === 'EVERY_DAY' ? 'Attendance Setiap Hari' : 'Attendance Kalender Kerja' }}
                </span>
            @endif
