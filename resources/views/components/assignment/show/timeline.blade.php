            ...
            @foreach($logs as $log)
                @php
                    ...
                    [$label, $icon, $dotClass] = match($log->action) {
                        ...
                        'ASSIGNMENT_UPDATED' => ['Assignment diperbarui', 'square-pen', 'bg-blue-500'],
                        ...
                        'COMPLETION_REJECTED', 'NEEDS_REVISION' => ['Memerlukan revisi', 'rotate-ccw', 'bg-amber-500'],
                        'CHECKOUT_CORRECTION_REQUESTED' => ['Koreksi Check Out diajukan', 'clock-3', 'bg-blue-500'],
                        'CHECKOUT_CORRECTION_APPROVED' => ['Koreksi Check Out disetujui', 'circle-check', 'bg-emerald-500'],
                        'CHECKOUT_CORRECTION_REJECTED' => ['Koreksi Check Out ditolak', 'circle-x', 'bg-red-500'],
                        'ASSIGNMENT_NOT_WORKED', 'REVISION_NOT_WORKED' => ['Tidak dikerjakan', 'clock-x', 'bg-red-500'],
