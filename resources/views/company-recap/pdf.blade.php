...
<head>
    ...
    <style>
        * { font-family: DejaVu Sans, sans-serif; }
        ...
        .meta td { color:#64748b; padding-right:18px; }
        .meta strong { color:#172033; }
        .section-title { border-bottom:1px solid #dbe5f1; color:#0f172a; font-size:14px; margin:18px 0 8px; padding-bottom:6px; }
        ...
        .explain { background:#eff6ff; border:1px solid #bfdbfe; color:#334155; padding:10px 12px; }
        ...
        .breakdown th { background:#f1f5f9; color:#475569; font-size:9px; padding:7px; text-align:left; }
        .breakdown td { border:1px solid #e2e8f0; font-size:10px; padding:7px; }
        .employee-table { border-collapse:collapse; table-layout:fixed; width:100%; }
        .employee-table thead { display:table-header-group; }
        .employee-table th { background:#1d4ed8; color:#fff; font-size:8px; padding:8px 7px; text-align:left; text-transform:uppercase; }
        .employee-table td { border:1px solid #dbe5f1; font-size:9px; padding:8px 7px; vertical-align:top; }
        ...
        .rate { background:#f8fafc; border:1px solid #e2e8f0; display:inline-block; font-size:11px; padding:3px 6px; }
        .center { text-align:center; } .empty { color:#94a3b8; padding:20px; text-align:center; }
        .signature { margin-top:28px; page-break-inside:avoid; text-align:center; }
        .signature-space { height:46px; } .signature-line { border-top:1px solid #172033; margin:0 auto 4px; width:180px; }
