    ...
    @if($showForm)
        ...
        <div class="mb-6 rounded-2xl border border-blue-200 bg-blue-50/50 p-5">
            ...
            <h4 class="mb-4 font-semibold text-slate-800">
                {{ $editingId ? 'Edit Team' : 'Tambah Team Baru' }}
            </h4>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <label class="flex items-center gap-2 sm:col-span-2">
                    ...
                    <span class="text-sm text-slate-700">Team aktif</span>
        ...
        <table class="min-w-full divide-y divide-slate-200">
            ...
            <tbody class="divide-y divide-slate-200 bg-white">
                ...
                @forelse($teams as $team)
                    ...
                    <tr wire:key="team-{{ $team->id }}" class="hover:bg-slate-50">

                        <td class="px-4 py-3 text-sm font-semibold text-slate-800">{{ $team->code }}</td>

                        <td class="px-4 py-3 text-sm text-slate-700">{{ $team->name }}</td>

                        <td class="px-4 py-3 text-center text-sm text-slate-500">{{ $team->employment_histories_count }}</td>
