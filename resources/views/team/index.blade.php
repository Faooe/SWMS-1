                    ...
                    @forelse($teams as $team)
                        ...
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-6 py-5 text-center">
                                ...
                                <form
                                    action="{{ route('teams.toggle-status', $team) }}"
                                    method="POST"
                                    onsubmit="return confirm('{{ $team->is_active ? 'Nonaktifkan' : 'Aktifkan' }} team {{ $team->name }}?')">
                            ...
                            <td class="px-6 py-5">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form
                                        ...
                                        <button type="submit" title="Delete Team" class="flex h-9 w-9 items-center justify-center rounded-xl bg-red-100 text-red-600 transition hover:bg-red-600 hover:text-white">
