    ...
    <div class="grid gap-8 xl:grid-cols-3">
        ...
        <x-ui.card class="h-fit xl:col-span-1">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="relative">
                    @if($user->profile_photo || $user->employee?->photo)
                        <img src="{{ secure_file_url($user->profile_photo ?? $user->employee?->photo) }}" class="h-24 w-24 rounded-full object-cover ring-4 ring-blue-50">
                    @else
